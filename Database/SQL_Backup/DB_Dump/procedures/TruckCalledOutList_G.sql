...
-- =============================================
CREATE PROCEDURE [dbo].[TruckCalledOutList_G] 
@RoleId int=null,
@UDID int=null,
...
BEGIN
	...
	BEGIN
		  ...
		  WHERE TD.IsActive=1   AND TD.IsCalledOut=1 AND TD.ActualDepatureDate  IS NULL
  END
  IF(@RoleId=2)
  BEGIN
		SELECT  TD.TruckDetailsId
		  ...
		  AND TD.IsActive=1  AND TD.IsCalledOut=1  AND TD.ActualDepatureDate  IS NULL
