...
-- =============================================
CREATE PROCEDURE [dbo].[BillableTrucks_G]
...
BEGIN
	...
	SET NOCOUNT ON;
		  ...
		  WHERE TD.IsActive=1 AND (TD.IsBilled=0 OR TD.IsBilled IS NULL)
		  AND (TD.IsCheckedIn=1 OR TD.ActualDepatureDate IS NOT NULL)
END
GO
