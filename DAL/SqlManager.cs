...
namespace DAL
{
    public class SqlManager
    {
     ...
     /*   public static SqlConnection OpenConnection()
        {
            //SqlConnection sqlConnection = new SqlConnection(@"Server=DESKTOP-HMO05CP\SQLEXPRESS;Database=LFZ_TruckPark_New_W;user id=sa;pwd=sa123");
            //SqlConnection sqlConnection = new SqlConnection(@"Server=172.106.164.4,1087;Database=ictp;user id=ictp;pwd=Ictp_zk@007");
            //SqlConnection sqlConnection = new SqlConnection(@"Server=S148-66-129-50\SQLEXPRESS;Database=LFZ_TruckPark_New;user id=sa;pwd=Zaksof@123;");
           // SqlConnection sqlConnection = new SqlConnection(@"Server=IP-208-109-15-4\SQLEXPRESS;Database=LFZ_TruckPark_New;user id=zaksof;pwd=lfzprodnew@1234;");
